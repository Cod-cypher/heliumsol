 ...
 *
 *   Anyone's message  — only HeliumSol's own phone number and email
 ...
 *                       This is what lets the team paste a booking link or send the
...
const KNOWN_EMAILS = [CONTACT_EMAIL, 'info@heliumsol.com'];
      ...
      {tokens.map((token, i) =>
        token.href ? (
          <a
            ...
            className="underline underline-offset-2 hover:opacity-70 rounded-sm"
          >
            {token.text}
          </a>
        ) : (
