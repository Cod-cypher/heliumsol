 ...
 * widget and a fresh greeting — while the transcript the team had been emailed about
 * sat on the server as an orphan, and the team got no second email either, because
