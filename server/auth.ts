 ...
 *
 * NOTE: production is currently served over HTTP (check /etc/nginx/sites-enabled/heliumsol.conf
 * for an SSL block). Admin login will not work over plain HTTP until
