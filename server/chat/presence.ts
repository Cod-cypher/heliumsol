 ...
 * a transcript and a composer whether or not anyone is still reading, so the team
 ...
 * to the team every time somebody followed a link that reloaded the page, while the
